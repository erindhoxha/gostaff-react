        ...
        <nav aria-label="alternative nav" id="sidebar" className="">
            <div className="transition border-r bg-gray-800 border-gray-600 top-10 w-full md:w-80 content-center shadow flex-col flex sidebar h-full min-h-screen">
                <div className='logo px-5 py-6 hidden md:block max-height-100'>
                    <h1 className="text-md bold font-bold text-white text-left pl-2"><Link to="/">GoStaff.com</Link></h1>
                </div>
                <div className={"px-5 content-center md:content-start text-left justify-between"}>
                    <ul className="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 text-center md:text-left">
                        <li className="mr-3 flex-1">
                            <Link to="/staff" className="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-white md:border-b border-gray-700 dark:border-gray-200 transition">
                        ...
                        <li className="mr-3 flex-1">
                            <Link to="/manage" className="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-white md:border-b border-gray-700 dark:border-gray-200 transition">
                        ...
                        <li className="mr-3 flex-1">
                            <Link to="/analytics"  className="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-black md:border-b border-gray-700 dark:border-gray-200 transition">
                                <i className="fas fa-chart-area pr-0 md:pr-3 text-white"></i><span className="pb-1 md:pb-0 text-xs md:text-base text-white dark:text-gray-600 md:text-black-900 block md:inline-block">Analytics</span>
                            </Link>
                        </li>
                        <li className="mr-3 flex-1">
                            <Link to="/settings" className="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-black md:border-b border-gray-700 dark:border-gray-200 transition">
                        ...
                        <li className="mr-3 flex-1">
                            <Link to="/calendar" className="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-black md:border-b border-gray-700 dark:border-gray-200 transition">
                ...
                <ul className="list-reset flex flex-row md:flex-col px-1 text-center md:text-left w-full">
                        <li className="mr-3 flex-1 w-full">
                            <Link to="/login" className="block pl-1 align-middle text-gray-800 no-underline md:border-b border-gray-700 hover:text-whitedark:border-gray-200 pb-3 transition">
                        ...
                        <li className="mr-3 flex-1 w-full">
                            <Link to="/register" className="block pl-1 align-middle text-gray-800 no-underline hover:text-white transition pt-5">
